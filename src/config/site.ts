...
export const site = {
  ...
  subhead:
    "기획부터 개발, 배포, 그리고 실제 사용자를 만나는 운영까지.\n함께 완성할 기획자, UI/UX 디자이너, 프론트엔드 개발자를 찾습니다.",
   ...
   * 노션 상태값(접수됨 / 서류 검토 / 구글 미트 / 합류)과 같은 흐름이다.
   */
  recruitingSteps: [
    {
      step: "01",
    ...
    },
    {
      ...
      title: "구글 미트",
      period: "서류 통과 시",
      desc: "메일로 일정을 맞춘 뒤 온라인으로 짧게 이야기 나눕니다.",
    },
    {
      step: "03",
      title: "최종 결과",
...
/*
 * 지금 뽑는 포지션을 앞에 둔다. 마감된 포지션은 지우지 않고 뒤에 남긴다.
 * 팀이 이미 어느 파트를 갖췄는지도 지원자에게 알려주는 정보다.
 */
