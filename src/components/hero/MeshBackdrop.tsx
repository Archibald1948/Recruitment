 ...
 */
const WAVE1_BODY =
  "radial-gradient(60% 24% at 50% 40%," +
  " rgba(9,5,6,0.96) 0%," +
  " rgba(20,11,13,0.9) 46%," +
  " rgba(56,30,32,0.46) 76%," +
  " rgba(56,30,32,0) 100%)";

const WAVE1_RIM =
  "radial-gradient(61% 25% at 50% 40%," +
  " rgba(244,206,196,0) 66%," +
  " rgba(244,206,196,0.52) 76%," +
  " rgba(244,206,196,0.16) 83%," +
  " rgba(244,206,196,0) 92%)";
