// Magic UI · Light Rays (https://magicui.design/docs/components/light-rays)
// 레지스트리에서 받은 원본에 하이드레이션 관련 주석만 덧붙였다.
"use client"
...
export function LightRays({
  ...
  useEffect(() => {
    // 광선 위치를 난수로 정하므로 서버에서 만들면 하이드레이션이 어긋난다.
    // 마운트 후에 생성하는 것이 이 컴포넌트의 의도다.
