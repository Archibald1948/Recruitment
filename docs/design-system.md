...
/* CTA 그라디언트 (B안 ContactButton) */
--grad-cta:      linear-gradient(123deg, #18011F 7%, #B600A8 37%, #7621B0 72%, #BE4C00 100%);
--cta-shadow:    0 4px 4px rgba(181, 1, 167, 0.25), 4px 4px 12px #7721B1 inset;
```

### 히어로 웨이브 팔레트 (MeshGradient)

위 → 아래로 밝은 라벤더에서 검정으로 떨어진다. 마지막 색이 `--bg`와 **동일해야** 이음매가 사라진다.
